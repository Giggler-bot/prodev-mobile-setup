...
import { PropertyListingProps } from "@/interfaces"; // This will be created/updated in Step 4
import FontAwesome from "@expo/vector-icons/FontAwesome";
import { styles } from "@/styles/_propertyCardStyle"; // This will be created in Step 3
...
const PropertyListingCard: React.FC<PropertyListingProps> = ({
  ...
  return (
    <ImageBackground
      source={require("@/assets/images/sample-image.png")} // Make sure this image exists
